package app.psn.std.opts.web;

import app.psn.std.home.service.StdHomeService;
import app.psn.std.opts.service.StdOptsService;
...
@RequestMapping("/std")
public class StdOptsController {

	private final StdHomeService homeService;

	private final StdOptsService stdOptsService;
	...
	public String guildPg(Model model) {
		...
		return ViewPathEnum.STD.to("/opts/stdOpts");
	...
	public String qrCodePg(Model model) {
		...
		model.addAttribute("qrStr", stdOptsService.QrCodeStr());

		return ViewPathEnum.STD.to("/opts/stdQrCode");
	...
	public String pwChgPg() {
		...
		return ViewPathEnum.STD.to("/opts/stdPwChg");
	...
	public ResponseEntity<ResponseBody<Object>> pwChgAx(@RequestParam(value = "currentPw", defaultValue = "") String currentPw // 기존 패스워드
		...
		stdOptsService.pwChg(currentPw, newPw);
	...
	public String pointHistoryPg(Model model) {
		...
		model.addAttribute("weekStatics", stdOptsService.sltWeekStatics());

		model.addAttribute("pointHistory", stdOptsService.sltRewardHistory());

		return ViewPathEnum.STD.to("/opts/stdPointHistory");
