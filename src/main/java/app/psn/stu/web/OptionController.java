...
public class OptionController {
	...
	public String pointHistoryPg(Model model) {
		model.addAttribute("weekStatics", optionService.sltWeekStatics()); // 주간 경험치, 포인트 적립내역 통계
		model.addAttribute("pointHistory", optionService.sltPointHistory()); // 누적 경험치 포인트 적립내역 목록
